...
const GRILLEE_ALARMBIT_FAN = 0;
const GRILLEE_ALARMBIT_BATTERY = 1;
const GRILLEE_ALARMBIT_PROBE1 = 2;
const GRILLEE_ALARMBIT_PROBE2 = 3;
...
export class AlarmService {
  ...
  handleIncomingAlarm(alarm: number) {
    ...
    if (this.alarmState.hasChangedTo(GRILLEE_ALARMBIT_FAN, alarm, true)) {
    ...
    } else if (this.alarmState.hasChangedTo(GRILLEE_ALARMBIT_BATTERY, alarm, true)) {
    ...
    } else if (this.alarmState.hasChangedTo(GRILLEE_ALARMBIT_PROBE1, alarm, true)) {
    ...
    } else if (this.alarmState.hasChangedTo(GRILLEE_ALARMBIT_PROBE2, alarm, true)) {
