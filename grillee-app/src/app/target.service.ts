...
const GRILLEE_SERVICE_UUID = '32b33b05-6ac4-4137-9ca7-6dc3dbac4e41';
const GRILLEE_CHARACTERISTIC_ALARM_UUID = '06817906-f5db-4d66-86e4-776e74074cd6';
const GRILLEE_CHARACTERISTIC_SETPOINT1_UUID = '857f0daf-b9e1-45c9-9df3-c935f3e0f163';
const GRILLEE_CHARACTERISTIC_SETPOINT2_UUID = '779d932a-c52c-43a0-a38f-668e0bc76f68';
const GRILLEE_CHARACTERISTIC_TEMPERATURE1_UUID = 'fc24e2b1-9612-4a85-8f13-c7c0b8ed74c9';
const GRILLEE_CHARACTERISTIC_TEMPERATURE2_UUID = '94570d21-a9ca-45d7-a313-8238593286e5';
const GRILLEE_CHARACTERISTIC_FAN_UUID = '0303ed74-974e-4ae2-8cee-7296eaffadfa';
const GRILLEE_CHARACTERISTIC_RPM_UUID = '26552eef-1507-4e7d-8845-99b815841856';
const GRILLEE_CHARACTERISTIC_BATTERY_UUID = '12325d24-0357-4877-b57a-d323793b44b3';
const GRILLEE_CHARACTERISTIC_SENSORTYPE1_UUID = 'a4b7ca52-c743-4931-9153-ec28030a41a4';
const GRILLEE_CHARACTERISTIC_SENSORTYPE2_UUID = '7488eed8-6b19-4391-9a83-9c97d6f10319';
...
export class TargetService {
  ...
  scan(callbackScanNewDevice: Function) {
    this.ble.scan([GRILLEE_SERVICE_UUID], 3).subscribe(
      device => {
  ...
  getSubscriptionForFanRpm(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_RPM_UUID);
  }

  getSubscriptionForFanSpeed(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_FAN_UUID);
  }

  getSubscriptionForBattery(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_BATTERY_UUID);
  }

  getSubscriptionForProbe1(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_TEMPERATURE1_UUID);
  }

  getSubscriptionForProbe2(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_TEMPERATURE2_UUID);
  }

  getSubscriptionForSetpoint1(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_SETPOINT1_UUID);
  }

  getSubscriptionForSetpoint2(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_SETPOINT2_UUID);
  }

  getSubscriptionForSensorType1(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_SENSORTYPE1_UUID);
  }

  getSubscriptionForSensorType2(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_SENSORTYPE2_UUID);
  }

  getSubscriptionForAlarm(): BehaviorSubject<number> {
    return this.getSubscriptionForUuid(GRILLEE_CHARACTERISTIC_ALARM_UUID);
  }
  ...
  setAlarmAck() {
    ...
    this.sendBleDataNumber(GRILLEE_CHARACTERISTIC_ALARM_UUID, 'uint8_t', 128);
  }
  ...
  setFanSpeed(fanSpeed: number) {
    ...
    this.sendBleDataNumber(GRILLEE_CHARACTERISTIC_FAN_UUID, 'uint8_t', fanSpeed);
  ...
  setSetpoint1(setpoint: number) {
    ...
    this.sendBleDataNumber(GRILLEE_CHARACTERISTIC_SETPOINT1_UUID, 'uint16_t', setpoint);
  ...
  setSetpoint2(setpoint: number) {
    ...
    setpoint = Math.max(Math.min(setpoint, 200), 0);
    this.sendBleDataNumber(GRILLEE_CHARACTERISTIC_SETPOINT2_UUID, 'uint16_t', setpoint);
  ...
  setSensorType1(sensorType: number) {
    ...
    this.sendBleDataNumber(GRILLEE_CHARACTERISTIC_SENSORTYPE1_UUID, 'uint8_t', sensorType);
  ...
  setSensorType2(sensorType: number) {
    ...
    this.sendBleDataNumber(GRILLEE_CHARACTERISTIC_SENSORTYPE2_UUID, 'uint8_t', sensorType);
  ...
  onDeviceConnected(peripheral: BlePeripheral, connectedCallback: Function = null) {
    ...
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_FAN_UUID, 'uint8_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_RPM_UUID, 'uint16_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_BATTERY_UUID, 'float32_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_TEMPERATURE1_UUID, 'int16_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_TEMPERATURE2_UUID, 'int16_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_SETPOINT1_UUID, 'uint16_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_SETPOINT2_UUID, 'uint16_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_ALARM_UUID, 'uint8_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_SENSORTYPE1_UUID, 'uint8_t');
    this.addReadAndRegisterBLE(GRILLEE_CHARACTERISTIC_SENSORTYPE2_UUID, 'uint8_t');
  ...
  registerForBLENotifications(entry: ReadAndRegisterData) {
    ...
    this.ble.startNotification(this.bleDevice.id, GRILLEE_SERVICE_UUID, entry.uuid).subscribe(
      (data: ArrayBuffer) => {
  ...
  sendBleDataNumber(characteristic: string, datatype: string, data: number) {
    ...
    this.ble.write(this.bleDevice.id, GRILLEE_SERVICE_UUID, characteristic, this.numberToBytes(data, datatype)).then(
      result => {
  ...
  sendBleDataBoolean(characteristic: string, data: boolean) {
    this.ble.write(this.bleDevice.id, GRILLEE_SERVICE_UUID, characteristic, this.boolToBytes(data)).then(
      result => {
  ...
  readSensorType1(): number {
    return this.readBleDataFromUuid(GRILLEE_CHARACTERISTIC_SENSORTYPE1_UUID);
  }

  readSensorType2(): number {
    return this.readBleDataFromUuid(GRILLEE_CHARACTERISTIC_SENSORTYPE2_UUID);
  }
  ...
  readBleData(entry: ReadAndRegisterData) {
    this.ble.read(this.bleDevice.id, GRILLEE_SERVICE_UUID, entry.uuid).then(
      (data: ArrayBuffer) => {
